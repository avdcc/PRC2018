...
def getPlayers():
  ...
  for index, row in csv.iterrows():
    ...
    print(":temNationality :n" + cleaner(row["nationality"]) + " ;")
...
def getSeason():
  ...
  for index, row in csv19.iterrows():
    ...
    print(":PlayerSeason ;")
    print(":year 2019 ;")
    print(":epocaDe :p" + str(row["id"]) + " ;")
    print(":fazParte :t" + cleaner(str(row["club"])) + "_2019 ;")
  ...
  for index, row in csv18.iterrows():
    ...
    print(":year 2018 ;")
    print(":epocaDe :p" + str(row["id"]) + " ;")
    print(":fazParte :t" + cleaner(str(row["club"])) + "_2018 ;")
